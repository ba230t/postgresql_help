...
def get_postgresql_versions():
    ...
    :return: List of available PostgreSQL versions, e.g. ['python_12.1', 'python_12.2', ..., 'python_12.9', 'python_12.10'].
    """
    ...
    return sorted(directories, key=lambda x: version_key(x.split("_")[1]))
